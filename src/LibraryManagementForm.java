...
public class LibraryManagementForm extends JFrame {
	static LibraryManagementForm frame;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					frame = new LibraryManagementForm();
	...
	public LibraryManagementForm() {
		...
		JButton btnIssueBook = new JButton("Check Out Book");
		btnIssueBook.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				CheckOutForm.main(new String[]{});
				frame.dispose();
			}
		});
		btnIssueBook.setFont(new Font("Tahoma", Font.PLAIN, 13));
		
		JButton btnViewIssuedBooks = new JButton("View Checked Out Books");
		btnViewIssuedBooks.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ViewCheckedOutBooks.main(new String[]{});
			}
		});
