...
public class CheckOutForm extends JFrame {
	...
	public CheckOutForm() {
		...
		JLabel lblCardNo = new JLabel("Library Card No");
		
		JLabel lblBorrowerName = new JLabel("Borrower Name");
		
		
		JButton btnIssueBook = new JButton("Checkout Book");
		btnIssueBook.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				
			int bookId = Integer.parseInt(textField_1.getText());
			int branchId=Integer.parseInt(textField_2.getText());
			String cardNo=textField_3.getText();
			//String borrowerName = textField_4.getText();
			
			
			if(CheckOutDao.checkBook(bookId)){
			
			int i=CheckOutDao.save(bookId, branchId, cardNo);
			if(i>0){
				JOptionPane.showMessageDialog(CheckOutForm.this,"Book issued successfully!");
				LibraryManagementForm.main(new String[]{});
				frame.dispose();
				
			}else{
				JOptionPane.showMessageDialog(CheckOutForm.this,"Sorry, unable to issue!");
			}//end of save if-else
			
			}else{
				JOptionPane.showMessageDialog(CheckOutForm.this,"Sorry, Callno doesn't exist!");
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createSequentialGroup()
							.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
								...
								.addComponent(lblCardNo, GroupLayout.PREFERRED_SIZE, 108, GroupLayout.PREFERRED_SIZE)
								.addComponent(lblBorrowerName, GroupLayout.PREFERRED_SIZE, 100, GroupLayout.PREFERRED_SIZE))
							.addGap(10)
							.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
